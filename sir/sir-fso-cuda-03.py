...
Usage:
python sir-fso-cuda-xx.py -p <inputpath> -i <inputfile> -d<debug> --sx <num1> --sy <num2> --ex <num3> --ey <num4> -v <videofile> -o<output>
Example:
Python sir-fso-cuda-xx.py -p d:\data\  -i *.fits -d True --sx 250 --sy 250 --ex 750 --ey 750 -v test.avi -o True
...
2019/07/06:
sir-fso-03.py: timing logic revised
sir-fso-cuda-03.py: timing logic revised
...
def main(argv):
	...
	try:
		...
		print ('Usage: python sir-fso-cuda-xx.py -p <inputpath> -i <inputfile> --sx <num1> --sy <num2> --ex <num3> --ey <num4> -v <videofile> -o')
		print ('Example: python sir-fso-cuda-xx.py -p d:\\fso-test -i *.fits -d False --sx 200 --sy 200 --ex 700 --ey 700  -v test.avi -o True')
		sys.exit(2)
	...
	for opt, arg in opts:
		numtmp = numtmp + 1
	if (numtmp != 9):
		print ('Usage: python sir-fso-cuda-xx.py -p <inputpath> -i <inputfile> -d --sx <num1> --sy <num2> --ex <num3> --ey <num4> -v <videofile> -o')
		print ('Example: python sir-fso-cuda-xx.py -p d:\\fso-test -i *.fits -d False --sx 200 --sy 200 --ex 700 --ey 700  -v test.avi -o True')
		sys.exit(2)
...
#            plt.show()
				...
				dtime = int((end - start).total_seconds() * 1000)
				total_time = total_time + dtime
				pstr = ('id:%5d   dx=%7.2f   dy=%7.2f   corr=%7.2f Runtime=%d ms  %s' % (
				i, dis_s_subpix[0], dis_s_subpix[1], cor, dtime, filename[i][dirnlen:]))
		...
		dxy = np.array(dxy)
		print('Total time used with cuda device %d: %d ms ...'%(cp.cuda.Device().id,total_time))
		return dxy
