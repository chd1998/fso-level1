...
if [ $# -ne 6 ];then
  echo "Usage: ./fso-sync-wget-multithread.sh srcip destdir user password datatype(TIO or HA) threadnumber"
  echo "Example: ./fso-sync-wget-multithread.sh  ftp://192.168.111.120 /lustre/data tio ynao246135 TIO 5"
  exit 1
fi
...
echo "          (Release 0.5 20190702 14:49)                 "
echo "                                                       "
