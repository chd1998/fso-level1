...
if [ $# -ne 5 ]  ;then
  ...
  echo "Example: ./fso-copy-wget.sh ftp://192.168.111.120 /cygdrive/f 2019 0703 TIO"
  exit 1
fi
...
#destdir1 for wget
destdir1=${destpre0}${syssep}
#destdir for lftp
destdir=${destpre0}${syssep}${srcyear}${srcmonthday}${syssep}${datatype}
