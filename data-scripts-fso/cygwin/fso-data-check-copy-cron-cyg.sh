...
echo " "
echo "$today $ctime: $datatype Checking, please wait..."
/cygdrive/d/chd/LFTP4WIN-master/home/chd/fso-data-check-cron-cyg.sh /cygdrive/d/chd/LFTP4WIN-master/home/chd/$(date +\%Y\%m\%d)/$datatype $datatype $fileformat $stdsize > /cygdrive/d/chd/LFTP4WIN-master/home/chd/log/check-$datatype-size.log &
>>>>>>> 70676ab2c5cea9decc86dbfd32c1c1512b616b71
...
=======
echo "$today $ctime: $datatype Copying, please wait..."
/cygdrive/d/chd/LFTP4WIN-master/home/chd/fso-copy-wget-error-cron-cyg.sh $server $port $user $password /cygdrive/d/chd/LFTP4WIN-master/home/chd/log/size-error-of-$datatype-fits@$(date +\%Y\%m\%d)-total.list > /cygdrive/d/chd/LFTP4WIN-master/home/chd/log/$datatype-error-copy-$(date +\%Y\%m\%d).log &
>>>>>>> 70676ab2c5cea9decc86dbfd32c1c1512b616b71
...
if [ $errsize2 -eq 0 ]; then
  echo "$today: $datatype data is O.K.!" | email -s "Result of $datatype Data Sync @ $today" nvst_obs@ynao.ac.cn
  echo "$today: $datatype data is O.K.!" | email -s "Result of $datatype Data Sync @ $today" chd@ynao.ac.cn
else
