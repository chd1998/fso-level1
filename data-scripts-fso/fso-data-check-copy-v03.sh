...
errlist=/home/chd/log/$datatype-$fileformat@$monthday-error-total.list
...
#comparing remote and local file(s),creat local missing file(s)
  ...
  /home/chd/fso-data-check-remote-cron.sh $server $port $user $password $year $monthday $datatype $fileformat > /home/chd/log/check-remote-$datatype-size@$today.log &
