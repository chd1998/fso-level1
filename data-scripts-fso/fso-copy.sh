...
if [ $# -ne 5 ]  ;then
  ...
  echo "Usage: ./fso-copy.sh srcip dest year(4 digits)  monthday(4 digits) datatype(TIO/HA)"
  echo "Example: ./fso-copy.sh ftp://192.168.111.120 /lustre/data 2019 0427 TIO"
  exit 1
fi
...
echo "                      fso-copy.sh                        "  
echo "                                                         "
echo "             Relase 1.1     20190702  00:21              "
