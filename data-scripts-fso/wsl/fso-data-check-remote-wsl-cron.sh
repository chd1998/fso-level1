...
#usage: ./fso-data-check-remote-wsl-cron.sh ip port user passwd year monthday datatype fileformat localdrive"
#example: ./fso-data-check-remote-wsl-cron.sh 192.168.111.120 21 tio ynao246135 2019 0907 fits e"
#example: ./fso-data-check-remote-wsl-cron.sh 192.168.111.122 21 ha ynao246135 2019 0907 fits f"
#press ctrl-c to break the script
#change log:
#           Release 0.1.0 First working prototype
#           Release 0.1.1 modified to work under wsl
...
if [ $# -ne 8 ];then
  echo "usage: ./fso-data-check-remote-wsl-cron.sh ip port user passwd  year monthday datatype fileformat localdrive"
  echo "example: ./fso-data-check-remote-wsl-cron.sh 192.168.111.120 21 tio ynao246135 2019 0907 fits e"
  echo "example: ./fso-data-check-remote-wsl-cron.sh 192.168.111.122 21 ha ynao246135 2019 0907 fits f "
  exit 0
fi
...
remotelist=$logpath/$datatype-$fileformat-$year$monthday-$server-wsl.list
locallist=$logpath/$datatype-$fileformat-$year$monthday-local-wsl.list
difflist=$logpath/$datatype-$fileformat-$year$monthday-diff-wsl.list
