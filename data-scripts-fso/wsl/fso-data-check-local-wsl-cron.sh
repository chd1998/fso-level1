...
#usage: ./fso-data-check-local-wsl-cron.sh /youdir year monthday datatype fileformat standardsize(in bytes)
#example: ./fso-data-check-local-wsl-cron.sh e 2019 0915 TIO fits 11062080
#example: ./fso-data-check-local-wsl-cron.sh f 2019 0915 HA fits 2111040
#example: ./fso-data-check-local-wsl-cron.sh g 2019 0721 SP fits 5359680
#change log:
...
if [ $# -ne 6 ];then
  echo "#usage: ./fso-data-check-local-wsl-cron.sh /youdir year monthday datatype fileformat standardsize(in bytes)"
  echo "example: ./fso-data-check-local-wsl-cron.sh e 2019 0915 TIO fits 11062080"
  echo "example: ./fso-data-check-local-wsl-cron.sh f 2019 0915 HA fits 2111040"
  echo "example: ./fso-data-check-local-wsl-cron.sh g 2019 0915 SP fits 5359680"
  exit 0
fi
